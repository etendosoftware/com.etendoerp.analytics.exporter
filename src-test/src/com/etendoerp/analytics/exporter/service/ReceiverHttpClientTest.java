...
public class ReceiverHttpClientTest {
  ...
  private ReceiverHttpClient client;

  @Before
  public void setUp() {
    client = new ReceiverHttpClient(TEST_RECEIVER_URL);
  }
  ...
  public void testReceiverResponseGettersSetters() {
    ...
    response.setJob_id(TEST_JOB_ID);
    response.setMessage("Test message");
    response.setQueue_position(5);
  ...
  @Test
  public void testReceiverResponseSetJob_id() {
    ReceiverHttpClient.ReceiverResponse response = new ReceiverHttpClient.ReceiverResponse();
    response.setJob_id("job-123");
    assertEquals("job-123", response.getJobId());
  }

  @Test
  public void testReceiverResponseSetQueue_position() {
    ReceiverHttpClient.ReceiverResponse response = new ReceiverHttpClient.ReceiverResponse();
    response.setQueue_position(10);
  ...
  public void testReceiverResponseCompleteObject() {
    ...
    response.setJob_id("job-xyz");
    response.setMessage("Processing data");
    response.setQueue_position(3);
